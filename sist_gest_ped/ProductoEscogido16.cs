...
namespace CapaPresentacion.cs
{
    public partial class ProductoEscogido16 : Form
    {
        ...
        {
            int idProducto = 16; // Este sería dinámico en tu caso
        ...
        private void ProductoEscogido16_Load(object sender, EventArgs e)
        {
            int idProductoSeleccionado = 16; // Cambia este valor según el producto que quieras mostrar
