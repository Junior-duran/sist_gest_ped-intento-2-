...
namespace CapaPresentacion.cs
{
    public partial class ProductoEscogido4 : Form
    {
        ...
        {
            int idProducto = 4; // Este sería dinámico en tu caso
        ...
        private void ProductoEscogido4_Load(object sender, EventArgs e)
        {
            int idProductoSeleccionado = 4; // Cambia este valor según el producto que quieras mostrar
