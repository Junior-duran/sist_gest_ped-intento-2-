...
namespace CapaPresentacion.cs
{
    public partial class ProductoEscogido17 : Form
    {
        ...
        {
            int idProducto = 17; // Este sería dinámico en tu caso
        ...
        private void ProductoEscogido17_Load(object sender, EventArgs e)
        {
            int idProductoSeleccionado = 17; // Cambia este valor según el producto que quieras mostrar
