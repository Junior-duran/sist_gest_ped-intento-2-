...
namespace CapaPresentacion.cs
{
    public partial class ProductoEscogido18 : Form
    {
        ...
        {
            int idProducto = 18; // Este sería dinámico en tu caso
        ...
        private void ProductoEscogido18_Load(object sender, EventArgs e)
        {
            int idProductoSeleccionado = 18; // Cambia este valor según el producto que quieras mostrar
