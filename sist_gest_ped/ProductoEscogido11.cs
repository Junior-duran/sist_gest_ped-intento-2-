...
namespace CapaPresentacion.cs
{
    public partial class ProductoEscogido11 : Form
    {
        ...
        private void ProductoEscogido11_Load(object sender, EventArgs e)
        {
            int idProductoSeleccionado = 11; // Cambia este valor según el producto que quieras mostrar
