...
namespace CapaPresentacion.cs
{
    public partial class ProductoEscogico12 : Form
    {
        ...
        {
            int idProducto = 12; // Este sería dinámico en tu caso
        ...
        private void ProductoEscogico12_Load(object sender, EventArgs e)
        {
            int idProductoSeleccionado = 12; // Cambia este valor según el producto que quieras mostrar
