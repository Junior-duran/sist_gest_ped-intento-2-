...
namespace CapaPresentacion.cs
{
    ...
    public partial class ProductoEscogido9 : Form
    {
        ...
        {
            int idProducto = 9; // Este sería dinámico en tu caso
        ...
        private void ProductoEscogido9_Load(object sender, EventArgs e)
        {
            int idProductoSeleccionado = 9; // Cambia este valor según el producto que quieras mostrar
