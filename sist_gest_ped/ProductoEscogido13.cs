...
namespace CapaPresentacion.cs
{
    public partial class ProductoEscogido13 : Form
    {
        ...
        {
            int idProducto = 13; // Este sería dinámico en tu caso
        ...
        private void ProductoEscogido13_Load(object sender, EventArgs e)
        {
            int idProductoSeleccionado = 13; // Cambia este valor según el producto que quieras mostrar
