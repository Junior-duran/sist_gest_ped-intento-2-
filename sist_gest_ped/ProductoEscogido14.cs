...
namespace CapaPresentacion.cs
{
    public partial class ProductoEscogido14 : Form
    {
        ...
        {
            int idProducto = 14; // Este sería dinámico en tu caso
        ...
        private void ProductoEscogido14_Load(object sender, EventArgs e)
        {
            int idProductoSeleccionado = 14; // Cambia este valor según el producto que quieras mostrar
