...
namespace CapaPresentacion.cs
{
    ...
    public partial class ProductoEscogido6 : Form
    {
        ...
        {
            int idProducto = 6; // Este sería dinámico en tu caso
        ...
        private void ProductoEscogido6_Load(object sender, EventArgs e)
        {
            int idProductoSeleccionado = 6; // Cambia este valor según el producto que quieras mostrar
